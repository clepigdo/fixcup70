...
export default function FormPendaftaranMahasiswa() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        nama: "",
        kategori: "Mahasiswa", // <--- KATEGORI DIUBAH
        logo: null,
        contacts: {
            captain: { nama: "", no_wa: "" },
            official: { nama: "", no_wa: "" },
    ...
    return (
        <div className="min-h-screen bg-[#020d08] text-white font-sans relative flex flex-col pb-12">
            {/* TITLE DIUBAH */}
            <Head title="Pendaftaran Mahasiswa | FIX CUP 6.0" />
                            ...
                            >
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Contoh: Universitas Dian Nuswantoro" /* <--- DIUBAH */
                                                />
                                            </div>
                                        </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                                {[
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        label: "Surat Rekomendasi Kampus / BEM", // <--- DIUBAH
                                                        format: "PDF, JPG, PNG",
                                                    },
                                                ].map((doc) => (
                                                    <div
                                ...
                                {currentStep === 7 &&
                                    (() => {
                                        ...
                                        const reviewRows = [
                                            {
                                                label: "Nama Kampus", // <--- DIUBAH
                                                value: data.nama,
                                            },
                                            {
                                                label: "Logo Kampus", // <--- DIUBAH
                                        ...
                                        data.players.forEach((p, i) => {
                                            if (
                                                ...
                                                reviewRows.push({
                                                    label: `Pemain ${i + 1} - Scan KTM`, // <--- DIUBAH
                                        ...
                                        reviewRows.push(
                                            ...
                                            {
                                                label: "Surat Rekomendasi Kampus", // <--- DIUBAH
                                                value: data.documents
                        ...
                        >
                            ...
                            <p className="text-xs md:text-sm text-white/70 mb-8 relative z-10">
                                ...
                                <span className="font-bold text-white">
                                    Nama Universitas/Kampus {/* <--- DIUBAH */}
                                </span>{" "}
